...
android {
    namespace = "io.pitayacode.agent"
    compileSdk = 35

    defaultConfig {
        applicationId = "io.pitayacode.agent"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
